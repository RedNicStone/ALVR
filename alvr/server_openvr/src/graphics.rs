...
static COMPRESS_AXIS_ALIGNED_CSO: &[u8] = include_bytes!("../cpp/platform/win32/CompressAxisAlignedPixelShader.cso");
static COLOR_CORRECTION_CSO: &[u8] = include_bytes!("../cpp/platform/win32/ColorCorrectionPixelShader.cso");
...
static RGBTOYUV420_SHADER_COMP_SPV: &[u8] = include_bytes!("../cpp/platform/linux/shader/rgbtoyuv420.comp.spv");
static IMAGE_TO_LINEAR_SHADER_COMP_SPV: &[u8] = include_bytes!("../cpp/platform/linux/shader/imagetolinear.comp.spv");
...
pub fn initialize_shaders() {
    unsafe {
        ...
        crate::IMAGE_TO_LINEAR_SHADER_COMP_SPV_PTR = IMAGE_TO_LINEAR_SHADER_COMP_SPV.as_ptr();
        crate::IMAGE_TO_LINEAR_SHADER_COMP_SPV_LEN = IMAGE_TO_LINEAR_SHADER_COMP_SPV.len() as _;
    }
}
